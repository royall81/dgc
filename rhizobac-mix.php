     ...
     <div class="row py-0 py-md-5 pt-5 pt-md-0" style="font-size:16px;" >
          ...
          <div class="col-12 col-md-6  px-4 px-md-5">
               ...
               <p>
                    ...
                    <p>The microbiology restores essential plant biology. Trichoderma fungi increase the absorption range of the plant, improve nutrient density and water balance.
                    </p>

               </div>
               <div class="col-12 col-md-6  px-4 px-md-5 pt-5 pt-md-0 ">
                    <h2 class="">Benefits</h2><br>
                    <ul class="benefits">
                         <li>Combination of Trichoderma and rhizobacteria</li>
                         <li>Highly improved plant growth</li>
                         <li>Repairs root damage</li>
                         <li>Easy to use</li>
                         <li>Increases tolerance to drought and heat stress</li>
                         <li>Stimulates the growth of the mycorrhiza present</li>
                    </ul>
               </div>
          </div>
     </div>
     <div class="container" style="min-height:200px;">
          <div class="row py-5" style="font-size:16px;">

               <div class="col-12 col-md-6 px-4 px-md-5 pt-0 pt-md-5">
                    <h2 class="">Ingredients</h2><br>
                    <ul style="line-height: 1.7;">
                         <li><i>Rhizobacteria</i></li>
                         <li><i>Trichoderma fungi</i></li>
                         <li><i>Seaweed extract</i></li>
                         <li><i>Maltodextrin</i></li>
                         <!-- <li><i>Myconate</i></li> -->
                    </ul>
               </div>
