<div class="container container-md mt-5 mb-5">
    <div class="col-12 text-center pb-5" style="font-size:27px;">
        <h1>User guide <b style="font-weight:800;">Rhizobac Sachets</b></h1>
    </div>
</div>
            ...
            <div class="d-flex bd-highlight">
                <div class="row">
                    <div class="col-md-4 first-column p-1 pl-md-3">
                        <img class="img-fluid basic-header-thumbnail lazyloaded" src="/img/rhizobac-sachets-large.jpg">
                    </div>
                    <div class="col-md-8 p-0 p-md-3 second-column">
                        <p>In order to obtain maximum results with our Rhizobac Mix, simply follow the easy steps below.</p>
                        <p>For all product information, see our <a href="/rhizobac-mix">Rhizobacteria</a></p>
                        <p>Use water with a temperature around 24 °C / 75 °F.</p>
                        <p><strong>Conversion</strong></p>
                        <p>1 sachet = 10 gram / 0.35 ounces<br>1 liter = 0.26 gallon</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="d-flex bd-highlight">
                <div class="row">
                    <div class="col-md-12 p-0 p-md-3 second-column">
                        <h2 class="mt-4">Rhizobac Sachets 10 gram</h2><br>
                        <p><strong>Important</strong>: Water mixed with Rhizobac may be stored for a maximum of 5 hours. Therefore, never make more water than you need.</p>
                        <h2 class="mt-4">Dosage</h2><br>
                        <p><strong>For seedlings and cuttings</strong></p>
                        <p>1 sachet per 50 liter, once a week.</p>
                        <p><br><strong>Use of Rhizobac in the growth and flowering period</strong></p>
                        <p>1 sachet per 100 liter water, once a week.</p>
                        ...
                        <p>1 sachet per 50 liter, once.</p>
