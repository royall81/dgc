<div class="container container-md mt-5 mb-5"
    <div class="col-12 text-center pb-5">
        <h1>User guide <b style="font-weight:800;">Rhizobac Caps</b></h1>
    </div>
</div>
            ...
            <div class="d-flex bd-highlight">
                <div class="row">
                    <div class="col-md-4 first-column p-1 pl-md-3">
                        <img class="img-fluid basic-header-thumbnail lazyloaded" src="/img/rhizobac_large.jpg">
                    </div>
                    <div class="col-md-8 p-0 p-md-3 second-column">
                        <p>In order to obtain maximum results with our Rhizobac Caps, simply follow the easy steps below.</p>
